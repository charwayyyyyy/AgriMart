            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                <div className="mt-24 sm:mt-32 lg:mt-16">
                  <Link href="#featured" className="inline-flex space-x-6">
                    <motion.span
              ...
              >
                ...
                <div className="max-w-xl p-6">
                  ...
                  <div className="mt-4 flex items-center gap-x-4">
                    ...
                    <motion.button
                      className="rounded-full bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      Add to Cart
